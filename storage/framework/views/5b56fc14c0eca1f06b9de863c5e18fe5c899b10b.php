...
<div class="login-box">
    <div class="login-logo">
        <a href="<?php echo e(url('/')); ?>"><b>Moell</b> Blog</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        <p class="login-box-msg">Sign in to start your session</p>
        <form action="<?php echo e(url('backend/login')); ?>"  method="post">
            <?php echo e(csrf_field()); ?>


            <div class="form-group has-feedback <?php echo e($errors->has('email') ? ' has-warning' : ''); ?>">
            ...
            <div class="form-group has-feedback <?php echo e($errors->has('password') ? ' has-warning' : ''); ?>">
